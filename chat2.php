...
<!-- Communication -->
	...
	<div class="chat">
		...
		<p style="text-align: center;color: black;background: white;border-radius: 5px;">
			<small>Chat refresh automatically every 5sec.</small>
		</p>
		
		<?php
		$user = $_SESSION['user'];
		$chat = $_SESSION['user_id'].$_GET['user_id'];
...
margin-top: 100px;'>Start a new chat</p>";
		...
		$session = $_GET['user_id'].$_SESSION['user_id'];
